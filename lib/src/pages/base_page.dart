...
//        _displayPage(3);
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(child: Image.asset("assets/icons/footer-main.png"),elevation: 0, onPressed: () {
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                  title: Text("Pet Store"), icon:  Icon(Icons.store)
              ),
              BottomNavigationBarItem(icon: Icon(Icons.add), title: Text('')),
              BottomNavigationBarItem(
                title: Text("Adopt a Pet"), icon: Image.asset("assets/icons/mate.png",scale: 3,color: _page!=3? Colors.grey: Colors.primaries[0],),
              ),
              BottomNavigationBarItem(
                title: Text("Relocation"), icon: Image.asset("assets/icons/plane.png",scale: 3,color: _page!=4? Colors.grey: Colors.primaries[0],),
              ),
